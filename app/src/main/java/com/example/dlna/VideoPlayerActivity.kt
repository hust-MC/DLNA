 ...
 * 用于显示DLNA投屏的视频内容
 */
class VideoPlayerActivity : Activity(), SurfaceHolder.Callback, MediaPlayerManager.MediaStateListener {
    ...
    override fun onPlaybackCompleted() {
        Log.d("MCLOG", "onPlaybackCompleted")
    }
    ...
    override fun onPrepared(durationMs: Int) {
        Log.d("MCLOG", "onPrepared: $durationMs")
